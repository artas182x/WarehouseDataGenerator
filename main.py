...
# TODO What we need:
# At least one station which became not used from T2 to T3 comparing to T1 to T2 time. rarely_used flag
...
# At least one station should be rarely visited by employee
