...
# Some stations should be overloaded VERY probable
...
# Some stations should be more used between 8:00-10.00 AM and some between 4.00-6.00 PM DONE
# At night all stations should have at least one bike DONE
# At weekends people should not rent bikes from workplaces DONE
# On work days between 12:00-14:00 station where are workplaces should be overloaded VERY probable
